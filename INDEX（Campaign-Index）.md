...
- `npc-captive-hunter`：[[03-战役（Campaign）/01-NPC（NPCs）/老德雷克（Old-Drake）]] — 10/11 HP，AC12，提灯、短刀；位于栅门外约30尺
- `npc-hunter-mara`：[[03-战役（Campaign）/01-NPC（NPCs）/玛拉（Mara）]] — 10/11 HP，AC12，短弓、10箭、短剑；位于艾伦后方约80尺并继续跟进
- `npc-hunter-tobin`：[[03-战役（Campaign）/01-NPC（NPCs）/托宾（Tobin）]] — 10/11 HP，AC12，短剑、半燃火把；位于栅门外约40尺
